...
# JVM options - note: passed via xargs, NOT via shell variable expansion
...
# Use xargs to safely parse the JVM options string (handles the quoted -Xmx/-Xms correctly)
eval "set -- $(
